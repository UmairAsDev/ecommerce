...
class Category(models.Model):
    ...
    title = models.CharField(max_length=100, default="Categories")
...
class Tags(models.Model):
    name = models.CharField(max_length=200, unique=True, default="Untitled")
...
class Vendor(models.Model):
    ...
    title = models.CharField(max_length=100, default="EcomDiverse")
    ...
    contact = models.CharField( max_length=100, default="+312 (4862) 995")
...
class Products(models.Model):
    ...
    specifications = RichTextUploadingField(null=True, blank=True, default="This is the product")
    type = models.CharField(max_length=100, default="Organic", null=True, blank=True)
    stock_count = models.CharField(max_length=100, default="10", null=True, blank=True)
    life = models.CharField(max_length=100, default="100 Days", null=True, blank=True)
    mfd = models.DateTimeField(auto_now_add=False, null=True, blank=True)
    tags = TaggableManager(blank=True)
    # tags = models.ForeignKey(Tags, on_delete=models.SET_NULL, null=True, default="high quality")
